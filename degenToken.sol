...
// Transferring tokens: Names should be able to transfer their tokens to others.
// Redeeming tokens: Names should be able to redeem their tokens for items in the in-game store.
